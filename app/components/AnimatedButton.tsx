  ...
  return (
    <>
      <button className="relative bg-green-600 border-[1px] border-white text-white px-7 py-2 rounded-xl w-[160px] h-[40px] overflow-hidden group">
        ...
        <div className="flex justify-center py-1 pr-1 absolute inset-0 bg-blue-500 transform scale-0 group-hover:scale-100 transition-transform group-hover:duration-300 ease-out group-hover:z-0 ">
